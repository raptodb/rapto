...
pub fn main() !void {
    ...
    var sm: StateMachine = .init(&memory, writer);
    ...
    var qget: Query = .{
        .command = .GET,
        .flags = .{},
        .args = .init("\x03\x00\x00\x00key"),
    };
    const qset: Query = .{
        .command = .SET,
        .flags = .{},
        .args = .init("\x03\x00\x00\x00key\x01\x00\x00\x00\x00"),
    };
